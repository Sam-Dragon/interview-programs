package interview.programs.java_8_and_above.numbers.odd_even.aggregation.count;
...
public class StreamMapCollectorReduceWay {
    ...
    private static long countNumbers(List<Integer> numbers) {
        return numbers.stream()
                .filter(n -> n % 2 == 0)
                .collect(Collectors.reducing(0, i -> 1, Integer::sum));
    }
}
